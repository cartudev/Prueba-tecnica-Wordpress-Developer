...
function crearImagenes1(themeUrl) {
  ...
  var imagenes = ["Rectangle 3.jpg", "Rectangle 3-1.jpg", "Rectangle 3-1.jpg"];
...
function crearImagenes2(themeUrl) {
  ...
  var imagenes = ["Rectangle 3.png", "Rectangle 4.png", "Rectangle 5.png"];
...
var menuProductsSubMenu = document.querySelector(
  ".container-menu .menu-products .sub-menu"
);
...
var menuAboutUsSubMenu = document.querySelector(
  ".container-menu .menu-about-us .sub-menu"
);
